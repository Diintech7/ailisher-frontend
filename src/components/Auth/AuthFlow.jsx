...
const AuthFlow = ({ onAuthSuccess }) => {
  ...
  const handleLogin = async (email, password) => {
    ...
    try {
      ...
      const response = await fetch('https://ailisher.diintech.com/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const handleRegister = async (name, email, password) => {
    ...
    try {
      const response = await fetch('https://ailisher.diintech.com/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleClientRegister = async (clientData) => {
    ...
    try {
      ...
      const response = await fetch('https://ailisher.diintech.com/api/auth/clients', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
