...
const BookChaptersQRView = () => {
  ...
  useEffect(() => {
    const fetchBookAndChapters = async () => {
      ...
      try {
        // Fetch book details
        const bookResponse = await fetch(`https://ailisher.diintech.com/api/books/${bookId}`);
        const bookData = await bookResponse.json();

        // Fetch chapters
        const chaptersResponse = await fetch(`https://ailisher.diintech.com/api/books/${bookId}/chapters`);
