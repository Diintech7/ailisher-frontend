  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const topicsEndpoint = isWorkbook
        ? `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/workbooks/${workbookId}/chapters/${chapterId}/topics`
        : `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/books/${bookId}/chapters/${chapterId}/topics`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateEndpoint = isWorkbook
        ? `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/workbooks/${workbookId}/chapters/${chapter._id}`
        : `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/books/${bookId}/chapters/${chapter._id}`;
