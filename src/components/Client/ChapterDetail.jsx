  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const topicsEndpoint = isWorkbook
        ? `https://aipbbackend-c5ed.onrender.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics`
        : `https://aipbbackend-c5ed.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics`;
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const updateEndpoint = isWorkbook
          ? `https://aipbbackend-c5ed.onrender.com/api/workbooks/${workbookId}/chapters/${chapter._id}`
          : `https://aipbbackend-c5ed.onrender.com/api/books/${bookId}/chapters/${chapter._id}`;
