  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const topicsEndpoint = isWorkbook
        ? `https://aipbbackend.onrender.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics`
        : `https://aipbbackend.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics`;
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const updateEndpoint = isWorkbook
          ? `https://aipbbackend.onrender.com/api/workbooks/${workbookId}/chapters/${chapter._id}`
          : `https://aipbbackend.onrender.com/api/books/${bookId}/chapters/${chapter._id}`;
