  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const subtopicsUrl = isWorkbook 
        ? `https://aipbbackend-yxnh.onrender.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics`
        : `https://aipbbackend-yxnh.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateUrl = isWorkbook
        ? `https://aipbbackend-yxnh.onrender.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topic._id}`
        : `https://aipbbackend-yxnh.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics/${topic._id}`;
  ...
  const confirmDeleteTopic = async () => {
    try {
      ...
      const deleteUrl = isWorkbook
        ...
        : `https://aipbbackend-yxnh.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}`;
