...
const DatastoreItemsList = () => {
  ...
  const fetchItems = async () => {
    ...
    try {
      ...
      let endpoint = '';
      if (type === 'book') {
        endpoint = `https://ailisher.diintech.com/api/datastores/book/${id}/items`;
      } else if (type === 'chapter') {
        endpoint = `https://ailisher.diintech.com/api/datastores/chapter/${id}/items`;
      } else if (type === 'topic') {
        endpoint = `https://ailisher.diintech.com/api/datastores/topic/${id}/items`;
      } else {
        endpoint = `https://ailisher.diintech.com/api/datastores/book/${id}/items`;
