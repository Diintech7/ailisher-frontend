...
const AISWBSets = ({ topicId, onSetSelect }) => {
  ...
  const fetchSets = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://aipbbackend-yxnh.onrender.com/api/aiswb/topic/${topicId}/sets`, {
        headers: {
  ...
  const confirmDeleteSet = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://aipbbackend-yxnh.onrender.com/api/aiswb/topic/${topicId}/sets/${setToDelete}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleUpdateSet = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://aipbbackend-yxnh.onrender.com/api/aiswb/topic/${topicId}/sets/${editingSet.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
