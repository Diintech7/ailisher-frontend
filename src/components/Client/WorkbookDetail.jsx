...
const AddChapterModal = ({ isOpen, onClose, workbookId, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters`, {
        method: 'POST',
        headers: {
...
const EditWorkbookModal = ({ isOpen, onClose, workbook, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/workbooks/${workbook._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
...
const WorkbookDetail = () => {
  ...
  const fetchWorkbookDetails = async () => {
    ...
    try {
      ...
      const workbookResponse = await fetch(`https://ailisher.diintech.com/api/workbooks/${workbookId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      ...
      // Fetch chapters
      const chaptersResponse = await fetch(`https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
