    ...
    try {
      ...
      if (initialQuestion) {
        ...
        const response = await axios.put(
          `https://ailisher.diintech.com/api/objective-assets/questions/${initialQuestion._id}`,
          {
        ...
        const response = await axios.post(
          `https://ailisher.diintech.com/api/objective-assets/question-sets/${currentSet._id}/questions`,
          {
