    ...
    try {
      ...
      if (initialQuestion) {
        ...
        const response = await axios.put(
          `http://localhost:5000/api/subjective-assets/questions/${initialQuestion._id}`,
          {
        ...
        const response = await axios.post(
          `http://localhost:5000/api/subjective-assets/question-sets/${currentSet._id}/questions`,
          {
