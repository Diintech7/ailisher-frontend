  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateUrl = isWorkbook
        ? `https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`
        : `https://ailisher.diintech.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`;
  ...
  const fetchSubTopicDetails = async () => {
    ...
    try {
      ...
      const subtopicUrl = isWorkbook
        ...
        : `https://ailisher.diintech.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`;
