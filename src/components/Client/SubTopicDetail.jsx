  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateUrl = isWorkbook
        ? `https://aipbbackend-yxnh.onrender.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`
        : `https://aipbbackend-yxnh.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`;
  ...
  const fetchSubTopicDetails = async () => {
    ...
    try {
      ...
      const subtopicUrl = isWorkbook
        ...
        : `https://aipbbackend-yxnh.onrender.com/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`;
