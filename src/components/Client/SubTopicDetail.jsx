  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateUrl = isWorkbook
        ? `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`
        : `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopic._id}`;
  ...
  const fetchSubTopicDetails = async () => {
    ...
    try {
      ...
      const subtopicUrl = isWorkbook
        ...
        : `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/books/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`;
