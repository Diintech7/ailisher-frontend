...
const AddChapterModal = ({ isOpen, onClose, bookId, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/books/${bookId}/chapters`, {
        method: 'POST',
        headers: {
...
const EditBookModal = ({ isOpen, onClose, book, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/books/${book._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
...
const BookDetail = () => {
  ...
  const fetchBookDetails = async () => {
    ...
    try {
      ...
      const bookPromise = fetch(`https://ailisher.diintech.com/api/books/${bookId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      const chaptersPromise = fetch(`https://ailisher.diintech.com/api/books/${bookId}/chapters`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const confirmDeleteBook = async () => {
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/books/${bookId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
