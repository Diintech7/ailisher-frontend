...
const AddChapterModal = ({ isOpen, onClose, bookId, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://aipbbackend.onrender.com/api/books/${bookId}/chapters`, {
        method: 'POST',
        headers: {
...
const BookDetail = () => {
  ...
  const fetchBookDetails = async () => {
    ...
    try {
      ...
      const bookPromise = fetch(`https://aipbbackend.onrender.com/api/books/${bookId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      const chaptersPromise = fetch(`https://aipbbackend.onrender.com/api/books/${bookId}/chapters`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const confirmDeleteBook = async () => {
    try {
      ...
      const response = await fetch(`https://aipbbackend.onrender.com/api/books/${bookId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
