...
const AssetView = () => {
  ...
  useEffect(() => {
    const fetchAssets = async () => {
      try {
        ...
        const videosEndpoint = `https://ailisher.diintech.com/api/video-assets/${itemType}/${itemId}/videos?isWorkbook=${isWorkbook}`
        const pyqsEndpoint = `https://ailisher.diintech.com/api/pyq-assets/${itemType}/${itemId}/pyqs?isWorkbook=${isWorkbook}`
        const subjectiveEndpoint = `https://ailisher.diintech.com/api/subjective-assets/${itemType}/${itemId}/question-sets?isWorkbook=${isWorkbook}`
        const objectiveEndpoint = `https://ailisher.diintech.com/api/objective-assets/${itemType}/${itemId}/question-sets?isWorkbook=${isWorkbook}`

        // Determine endpoint based on item type for summaries
        let baseEndpoint = ""
        if (itemType === "book") {
          baseEndpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/workbooks/${workbookId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}`
        } else if (itemType === "chapter") {
          baseEndpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters/${chapterId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}`
        } else if (itemType === "topic") {
          baseEndpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}/topics/${topicId}`
        } else if (itemType === "subtopic") {
          baseEndpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/workbooks/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`
        }
  ...
  useEffect(() => {
    const fetchItemDetails = async () => {
      ...
      try {
        ...
        if (itemType === "book") {
          endpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/assets/${workbookId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}`
        } else if (itemType === "chapter") {
          endpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/assets/${workbookId}/chapters/${chapterId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}`
        } else if (itemType === "topic") {
          endpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/assets/${workbookId}/chapters/${chapterId}/topics/${topicId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}/topics/${topicId}`
        } else if (itemType === "subtopic") {
          endpoint = isWorkbook
            ? `https://ailisher.diintech.com/api/assets/${workbookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`
            : `https://ailisher.diintech.com/api/assets/${bookId}/chapters/${chapterId}/topics/${topicId}/subtopics/${subtopicId}`
        }
  ...
  const handleDeleteQuestion = async () => {
    ...
    try {
      const token = Cookies.get("usertoken")
      const endpoint = `https://ailisher.diintech.com/api/subjective-assets/questions/${deletingQuestion._id}`
  ...
  const handleDeleteObjectiveQuestion = async () => {
    ...
    try {
      const token = Cookies.get("usertoken")
      const endpoint = `https://ailisher.diintech.com/api/objective-assets/questions/${deletingObjectiveQuestion._id}`
  ...
  const handleDeleteVideo = async (videoId) => {
    try {
      const token = Cookies.get("usertoken")
      const endpoint = `https://ailisher.diintech.com/api/video-assets/videos/${videoId}`
  ...
  const handleDeletePYQ = async (pyqId) => {
    try {
      const token = Cookies.get("usertoken")
      const endpoint = `https://ailisher.diintech.com/api/pyq-assets/pyqs/${pyqId}`
