...
const EvaluatorsManagement = () => {
  ...
  const fetchEvaluators = async () => {
    try {
      ...
      const response = await fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/evaluators', {
        headers: {
  ...
  const fetchEvaluator = async (evaluatorId) => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/evaluators/${evaluatorId}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchClients = async () => {
    try {
      ...
      const response = await fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/admin/clients', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/admin/users', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  //     const response = await fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/admin/withdrawals', {
  //       headers: {
  //         'Authorization': `Bearer ${token}`
  //       }
  //     });
  ...
  //       fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/admin/verified-kyc', {
  //         headers: { 'Authorization': `Bearer ${token}` }
  //       }),
  //       fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/admin/rejected-kyc', {
  //         headers: { 'Authorization': `Bearer ${token}` }
  //       })
  //     ]);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/evaluators/${selectedEvaluator._id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleApproveSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch((process.env.REACT_APP_API_URL || 'http://localhost:4000') + '/api/clients/CLI677117YN7N/mobile/evaluations/addexistinguserasevaluator', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const submitKycAction = async () => {
    ...
    try {
      ...
      const baseUrl = `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/admin/evaluators/${kycTargetEvaluator._id}/kyc`;
  ...
  const handleVerify = async (evaluatorId) => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/evaluators/${evaluatorId}/verify`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleToggleStatus = async (evaluatorId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/evaluators/${evaluatorId}/togglestatus`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
