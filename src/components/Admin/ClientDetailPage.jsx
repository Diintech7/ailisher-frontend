...
const ClientDetailPage = () => {
  ...
  const fetchClientDetails = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/admin/clients/${clientId}`, {
        method: 'GET',
        headers: {
  ...
  const handleLoginAsClient = async () => {
    try {
      ...
      const response = await fetch(`https://ailisher.diintech.com/api/admin/login-as-client/${clientId}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
