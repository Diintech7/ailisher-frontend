...
export default function CreditAccountDetail() {
  ...
  const fetchAccountDetails = async () => {
    ...
    try {
      const response = await axios.get(`https://ailisher.diintech.com/api/admin/credit-account/${accountId}`,
  ...
  const fetchRechargePlans = async () => {
    try {
      const response = await axios.get(`https://ailisher.diintech.com/api/admin/${clientId}/get-recharge-plan`,
        { headers: { Authorization: `Bearer ${Cookies.get('admintoken')}` } }
      );
  ...
  const initiatePayment = async () => {
    ...
    try {
      ...
      const response = await fetch('https://ailisher.diintech.com/api/admin/paytm/initiate', {
        method: 'POST',
        headers: {
