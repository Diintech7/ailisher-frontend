...
const AnnotateAnswer = ({ submission, onClose, onSave }) => {
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      try {
        const url = `${process.env.REACT_APP_API_URL || 'http://localhost:4000'}/api/clients/CLI677117YN7N/mobile/userAnswers/questions/${submission.questionId?._id || submission.question?._id}/answers/${submission._id}/evaluation-update`
