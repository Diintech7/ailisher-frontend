...
const BASE_URL = 'https://ailisher.diintech.com/api/clients/CLI677117YN7N/mobile';
...
export const userAnswerService = {
  ...
  getPendingReviews: async () => {
    try {
      const response = await axios.get('https://ailisher.diintech.com/api/review/pending');
