...
const BASE_URL = 'https://aipbbackend-yxnh.onrender.com/api/clients/CLI677117YN7N/mobile';
...
export const userAnswerService = {
  ...
  getPendingReviews: async () => {
    try {
      const response = await axios.get('https://aipbbackend-yxnh.onrender.com/api/review/pending');
